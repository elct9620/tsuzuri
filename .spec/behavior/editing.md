...
## `ED-065` Checking the Segments through a row clicked with Shift
...
## `ED-066` Checking upward from the Current Segment
...
## `ED-067` Making a row current with Shift when no Segment is
