...
const zhHant: typeof en = {
  ...
  preview: {
    ...
    captionSpeaker: "說話者",
    zoomHint: "按住按鍵加滾輪也能縮放",
    snapping: "對齊其他段落與播放位置",
    snappingHint: "拖動時按住 Shift 可暫時切換對齊；其他拖動操作見快速鍵一覽。",
  ...
  shortcuts: {
    ...
    hints: {
      ...
      insertRange: "在空白波形上拖出範圍後，新增一段",
      cancel: "拖動中還沒放開時退回原位，否則捨棄拉出的範圍",
      next: "寫回，移到下一段的同一欄",
      lineBreak: "在這段字幕裡換行",
      revert: "放棄進入欄位後打的字，不佔復原步驟",
      split: "從游標處把這段分成兩段",
      checkRange: "勾選目前段落到點的那一列",
      snapping: "只在這次拖動中切換對齊",
